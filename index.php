	        ...
	        <div class="col-xl-4 col-lg-4 content-left">
	            <div class="content-left-wrapper">
	                ...
	                <div>
	                    ...
	                    <a href="tambah-file.php" class="btn_1 rounded yellow">Tambah Dokumen</a>
						
						<a href="tambah-file.php" class="btn_1 rounded mobile_btn yellow">Tambah Dokumen</a>
	                </div>
						...
						<?php
							...
							while ($row = mysqli_fetch_array($query)){
								...
								';
										...
										if($row['status']=='0'){
											echo '<td>Belum Enkripsi</td>
												  <td><a href="dekripsi.php?id='.$row['id_file'].'" class="btn_1 rounded red">Enkripsi</a></td>
												 ';
											
										}else if($row['status']=='1'){
											echo '<td>Enkripsi</td>
												  <td><a href="dekripsi.php?id='.$row['id_file'].'" class="btn_1 rounded yellow">Dekripsi</a></td>
												  <td><a href="files/'.$row['file'].'" class="btn_1 rounded green" target="_blank">Download</a></td>
											';
