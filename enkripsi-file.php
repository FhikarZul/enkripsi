...
<head>
    ...
    <title>Enkripsi Dokumen | Pengamanan File</title>
	    ...
	    <div class="row row-height">
	        <div class="col-xl-4 col-lg-4 content-left">
	            <div class="content-left-wrapper">
	                ...
	                <div>
						...
						<br>
						<br>
	                    <figure><img src="img/shield.png" alt="" class="img-fluid" width="270" height="270"></figure>
	        ...
	        <div class="col-xl-8 col-lg-8 content-right" id="start">
	            <div id="wizard_container">
	                ...
	                <form action="proses-enkripsi.php" method="post" enctype="multipart/form-data">
	                    ...
	                    <div>
	                        <div>
								...
								<div class="form-group add_bottom_30 add_top_20">
	                                <label>Upload File<br><small></small></label>
	                                <div class="fileupload">
	                                    <input type="file" name="file" class="required" accept=".xls,.xlsx,.pdf,.docx,.txt"  required>
	                                </div>
	                            </div>
