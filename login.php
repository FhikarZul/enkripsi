...
<head>
    ...
    <title>Login | Pengamanan File</title>
	    ...
	    <div class="row row-height">
	        <div class="col-xl-4 col-lg-4 content-left">
	            <div class="content-left-wrapper">
	                ...
	                <!-- /social -->
	                <div>
						<figure><img src="img/password.png" alt="" class="img-fluid" width="270" height="270"></figure>
	                    ...
	                    <div>
	                        <div>
	                            ...
	                            <div class="form-group add_top_30">
	                                ...
	                                <input type="text" name="username" id="name" class="form-control required" required>
	                            </div>
	                            ...
	                            <button type="submit" class="btn_1 rounded yellow">Login</button>
	                        </div>
	                        <!-- /step-->
